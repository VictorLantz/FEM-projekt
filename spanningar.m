...
%OKEJ H�R DYKER V�RA FEL UPP VICTOR!! V�RA F�RSKJUTNINGAR �R KONSTIGA!!!
%Rita upp f�rskjutningar
figure(3);
ad = extract(edof, a);
plotpar = [1, 4, 2];
xlabel('x-led, m'); ylabel('y-led, m'); title('F�rskjutningar i Kroppen');
...
xlabel('x-led, m'); ylabel('y-led, m'); title('Von-Mise-Sp�nningen i Kroppen');
